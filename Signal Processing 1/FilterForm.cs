...
namespace Signal_Processing_1
{
    public partial class FilterForm : Form
    {
        ...
        public FilterForm((double Ak, double BK)[] coef, string name, DataType type)
        {
            InitializeComponent();
        ...
        private void lPFilterButton_Click(object sender, EventArgs e)
        {
            ...
            (double Ak, double Bk)[]  coefFiltered = FourierTransform.LPFilter(coef, threshold);

            double[] filteredData = FourierTransform.FourierTransformReverse(coefFiltered);
        ...
        private void hPFilterButton_Click(object sender, EventArgs e)
        {
            ...
            (double Ak, double Bk)[] coefFiltered = FourierTransform.HPFilter(coef, threshold);
        ...
        private void bPFilterButton_Click(object sender, EventArgs e)
        {
            ...
            (double Ak, double Bk)[] coefFiltered = FourierTransform.BPFilter(coef, threshold0, threshold1);
        ...
        private void notchFilterButton_Click(object sender, EventArgs e)
        {
            ...
            (double Ak, double Bk)[] coefFiltered = FourierTransform.NotchFilter(coef, threshold0, threshold1);
